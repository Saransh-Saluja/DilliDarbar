    ...
    <footer className="relative bg-gradient-to-b from-black to-gray-900 border-t border-[#e3c493]/30 mt-10">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6 md:text-center">
            ...
            <div className="space-y-4 md:ml-12">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-[#e3c493] text-sm font-playfair leading-relaxed text-start">
                    1 Edgell Road<br />
                    Framingham, MA 01701
                  </p>
                </div>
          ...
          {/* Working Hours (new, in place of old Get In Touch) */}
          <div className="space-y-6 md:text-center">
            <h3 className="text-[#f5e3c6] text-lg font-playfair tracking-wider uppercase">
              Hours
            </h3>
            <div className="text-[#e3c493]/80 text-sm font-playfair leading-relaxed space-y-1 md:text-center">
              <p>Monday – Sunday</p>
              <p>11:00 AM – 3:00 PM</p>
              <p>5:00 PM – 10:00 PM</p>
            </div>
